...
const csp = [
  ...
  `img-src 'self' data: blob: https://upload.wikimedia.org https://wsrv.nl https://flagcdn.com https://${supabaseHost} https://www.google-analytics.com https://www.googletagmanager.com`,
